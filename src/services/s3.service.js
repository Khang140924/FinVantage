 ...
 * @returns {Promise<{uploadUrl: string, fileKey: string}>} - Trả về đường dẫn tải lên và khóa tệp duy nhất
 */
export const generateUploadUrl = async (fileName, contentType) => {
  ...
  const bucketName = process.env.S3_RAW_BUCKET_NAME || 'finvantage-raw-invoices-dev';
